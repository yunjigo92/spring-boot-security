...
- Authentication 는 인증된 결과만 저장하는 것이 아니고, 인증을 하기 위한 정보와 인증을 받기 위한 정보가 동시에 들어 있습니다. 그래서 AuthenticationProvider의 authenticate() 에 인자로 들어가고 리턴값으로 나옵니다.
...
- Authentication 을 구현한 객체들은 일반적으로 Token 이라는 이름의 객체로 구현됩니다. 그래서 Authentication의 구현체를 인증토큰이라고 부릅니다.
...
- 인증 대상과 방식이 다양할 수 있기 때문에 인증 제공자도 여러개 올 수 있습니다.
